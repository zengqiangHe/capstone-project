...
import EditEventPage from './components/editButton/EditEventPage';
...
const[eventsList, setEventsList] = useState (defaultEventsList)
  ...
  return (
    ...
    element={
      ...
      <Route path="create"
    element={<Create addNewEvent={addNewEvent} />} />
     
     <Route path="erstellte-events"
    element={
      <ul>
        <HomePageTabs/>
      {eventsList.map(event => (
    ...
    <Route path="edit/:id" 
    element={
      <EditEventPage events={eventsList} updateEvent={updateEvent}/>
    }/>
